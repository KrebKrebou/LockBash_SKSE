...
void SetupINI() {
    ...
    const char* formulaCom = "# 1 = Requiem-like (Recommended)| 2 = Easy                   //Defaults to 1";
    const char* notificationCom = "# false = HUD messages off | true = HUD messages on          //Defaults to false";
    const char* logsCom = "# false = Log messages off | true = Log messages on          //Defaults to false";
